...
export async function getStaticProps({params}) {
    ...
    const gridStyle = stories_data.stories.[thisGallery].config;
...
export default function Story({storyTitle, storyStyle}) {
    ...
    const GalleryImages = stories_data.stories.[storyTitle].images.map((image, index) => {
        ...
        return (
            <div key={index}
                className={storyStyle == "single" ? "grid-item-single" : "grid-item"}
        ...
        <Gallery_Style>
            ...
            <MainGridStyle className={`${stickyNavAidClass}`}>
                <Masonry
                    ...
                    className="grid"
                    columnClassName={storyStyle == "single" ? "grid-column-single" : "grid-column" }
                >
                    {GalleryImages}
                </Masonry>
            </MainGridStyle>
